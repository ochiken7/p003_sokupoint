...
IMAGE_SLOTS = [
    ...
    # ホーム上部バナー 1 - PC/SP別指定
    ('banner_home_1', 'ホーム上部バナー 1 (PC)', '推奨: 1200x400px (3:1) - PC表示用'),
    ('banner_home_1_sp', 'ホーム上部バナー 1 (SP)', '推奨: 750x500px (3:2) - スマホ表示用。未設定ならPC版を表示'),
    # ホーム上部バナー 2 - PC/SP別指定
    ('banner_home_2', 'ホーム上部バナー 2 (PC)', '推奨: 1200x400px (3:1) - PC表示用'),
    ('banner_home_2_sp', 'ホーム上部バナー 2 (SP)', '推奨: 750x500px (3:2) - スマホ表示用。未設定ならPC版を表示'),
